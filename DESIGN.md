...
중앙 정렬 단일 컬럼 카드 레이아웃. 카드 최대 너비 400px, 뷰포트 전체에서 세로·가로 모두 flex 중앙 정렬. 420px 미만 브레이크포인트에서 카드 코너가 20px→16px로, 패딩이 줄고, 좌우로 나란하던 링크 쌍이 세로로 쌓인다. 간격은 4px 기준 스케일(4/8/12/16/24/32/48/64)을 따른다.
